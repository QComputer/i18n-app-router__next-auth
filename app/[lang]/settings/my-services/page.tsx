 ...
 * My Services Page
 * 
 * Page for staff users (MERCHANT, MANAGER, OWNER) to manage their own services.
 * This page allows staff to view and manage the services they provide.
 * 
 * Route: /[lang]/settings/my-services
 */
...
import { Plus, Clock, DollarSign, Edit, Trash2, Search, User } from "lucide-react"
import { Button } from "@/components/ui/button"
import { Input } from "@/components/ui/input"
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"
import { Badge } from "@/components/ui/badge"
import { toPersianDigits } from "@/lib/utils"
import { getServicesByStaffId } from "@/lib/services/service"
...
/**
 * My Services page component
 * 
 * @param props.params - Promise resolving to { lang: Locale }
 */
export default async function MyServicesPage(props: {
  ...
  // Only allow MERCHANT, MANAGER, OWNER roles
  if (!staff || !['MERCHANT', 'MANAGER', 'OWNER'].includes(staff.hierarchy)) {
    redirect(`/${locale}/dashboard`)
  }
  ...
  const t = {
    title: dict.service?.title || "My Services",
    ...
    noServicesDescription: "You haven't created any services yet. Create your first service to get started.",
