...
export default function OrganizationCreateForm({ dict, lang }: OrganizationCreateFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(dict.admin?.organizations?.saveSuccess || "Organization created successfully")
      setFormData({
        name: "",
        slug: "",
        type: "OTHER",
